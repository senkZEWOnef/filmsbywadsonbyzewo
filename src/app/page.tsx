    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-6">
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl font-light tracking-widest mb-6 text-white/95">
              FILMS BY WADSON
            </h1>
            <div className="w-24 h-px bg-white/60 mx-auto mb-8"></div>
          </div>
          
          <p className="text-lg md:text-xl font-light tracking-wide leading-relaxed text-white/90 max-w-3xl mx-auto mb-12">
            CRAFTING TIMELESS WEDDING FILMS THAT CAPTURE THE SOUL OF YOUR LOVE STORY
          </p>
          
          <div className="flex flex-col items-center">
            <a 
              href="#portfolio" 
              className="inline-block text-white/90 font-light tracking-widest text-sm hover:text-white transition-all duration-500 mb-4"
            >
              VIEW OUR WORK
            </a>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Full Day Coverage</h3>
              <p className="text-gray-300">From getting ready to reception, we capture every moment</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Cinematic Quality</h3>
              <p className="text-gray-300">Professional equipment and expert editing for stunning results</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">Receive your beautiful 10-15 minute film within 4-6 weeks</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold mb-2">Films by Wadson</h3>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Films by Wadson. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>

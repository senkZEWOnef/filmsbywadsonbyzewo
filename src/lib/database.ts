...
export type VideoRecord = {
  ...
  name: string;
  file_path: string;
  video_type: 'portfolio' | 'hero' | 'about_hero' | 'about_timeline_1' | 'about_timeline_2' | 'about_timeline_3' | 'about_timeline_4' | 'about_timeline_5' | 'about_timeline_6' | 'about_behind_scenes';
  created_at: string;
  updated_at: string;
};
